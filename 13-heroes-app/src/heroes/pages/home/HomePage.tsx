			...
			<>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
					...
					<Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
						...
						<CardContent className="space-y-4">
							<p className="text-sm text-gray-600 line-clamp-2">
								The Last Son of Krypton, protector of Earth and
					...
					<Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
						...
						<CardContent className="space-y-4">
							<p className="text-sm text-gray-600 line-clamp-2">
								The Dark Knight of Gotham City, using fear as a
								weapon against crime and corruption.
							</p>
					...
					<Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
						...
						<CardContent className="space-y-4">
							<p className="text-sm text-gray-600 line-clamp-2">
								Amazonian princess and warrior, champion of
					...
					<Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
						...
						<CardContent className="space-y-4">
							<p className="text-sm text-gray-600 line-clamp-2">
								Your friendly neighborhood Spider-Man, with
					...
					<Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
						...
						<CardContent className="space-y-4">
							<p className="text-sm text-gray-600 line-clamp-2">
								Billionaire genius inventor who uses his
								technology to protect the world.
							</p>
					...
					<Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
						...
						<CardContent className="space-y-4">
							<p className="text-sm text-gray-600 line-clamp-2">
								The Merc with a Mouth, an unpredictable
								anti-hero with accelerated healing powers.
							</p>
